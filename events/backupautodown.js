...
async function handleFacebookDownload(url, send) {
    try {
        ...
        console.error("Error in handleFacebookDownload:", error);
        send("Error occurred while processing Facebook download.");
    }
}
...
async function handleOtherPlatformDownload(url, send, platform) {
    try {
        ...
        console.error("Error in handleOtherPlatformDownload:", error);
        send(`Error occurred while processing ${platform} download.`);
    }
}
